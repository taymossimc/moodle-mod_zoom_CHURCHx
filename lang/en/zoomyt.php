...
$string['interpretation_enable_help'] = 'When enabled, interpreters can broadcast a translated audio channel during the meeting. Each interpreter must already exist as a licensed user on your Zoom account. Zoom pairs every interpreter with English; pick the second language they translate to or from.';
...
$string['err_interpretation_lang_required'] = 'Choose the language for this interpreter.';
