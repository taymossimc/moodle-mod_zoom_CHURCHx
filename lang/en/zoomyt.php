...
$string['viewrecordings'] = 'View Recordings';
...
$string['youtube_original_audio_language'] = 'Original audio track language';
$string['youtube_original_audio_language_desc'] = 'BCP-47 language code applied to the original (floor) audio track when a video is uploaded (YouTube\'s defaultAudioLanguage). YouTube only accepts real language codes here - the neutral codes "mul", "und" and "zxx" are rejected - so use a concrete code such as "en", "en-US" or "pt-BR". For multilingual sessions where you also add separate English/Portuguese tracks, give the original a code distinct from those tracks (e.g. original "en", alternates "en-US" and "pt-BR"). Leave blank to use the primary language. The title/description metadata language is unaffected.';
...
$string['duck_release_desc'] = 'How quickly the room audio returns after the interpreter stops speaking. Default 350.';
$string['duck_level_sc'] = 'Ducking sidechain gain';
$string['duck_level_sc_desc'] = 'Detection boost applied to the interpreter\'s voice when deciding how hard to duck the original room audio. Higher values make the original much quieter under the translation (the duck is more pronounced). 1 = no boost. Default 4.';
...
$string['video_synced'] = 'Video synced from YouTube';
...
$string['althosts_dropped'] = 'These alternative hosts were skipped because Zoom cannot currently use them: {$a}. They may have a pending invitation or an account in another Zoom organization. Alternative hosts must be active, licensed members of this Zoom account.';
$string['althosts_autoadded'] = 'Automatic instructor hosting added these eligible course instructors again: {$a}. Remove their eligible course role if they should not host this activity.';
...
$string['download_transcript'] = 'Download transcript';
$string['download_transcripts'] = 'Download transcripts from YouTube';
$string['download'] = 'Download';
$string['transcripts_downloaded'] = 'Transcripts downloaded successfully';
$string['no_transcripts_available'] = 'No transcripts available for this video';
$string['transcript_download_error'] = 'Failed to download transcripts: {$a}';
$string['pending_sync'] = 'Pending sync';
$string['transcripts_sync_hint'] = 'Transcripts will be downloaded when you click "Sync to YouTube"';
...
$string['err_meeting_security_required'] = 'Zoom requires at least one security option. Enable the waiting room, require a passcode, or require authenticated users.';
$string['interpretation'] = 'Interpretation';
$string['interpretation_spoken_header'] = 'Spoken-language interpretation';
$string['interpretation_sign_header'] = 'Sign-language interpretation';
$string['interpretation_spoken_label'] = 'Language interpretation';
$string['interpretation_sign_label'] = 'Sign-language interpretation';
$string['verify_problems_intro'] = 'Warning: the meeting was saved, but some Zoom settings could not be confirmed:';
$string['verify_fetch_failed'] = 'Could not verify the Zoom meeting settings: {$a}';
$string['verify_interp_not_applied'] = '{$a}: the interpreters were not applied on Zoom. The feature is likely disabled for the host\'s Zoom account.';
$string['verify_interp_missing_email'] = '{$a->label}: interpreter {$a->email} was not applied on Zoom.';
$string['verify_interp_lang_mismatch'] = '{$a->label}: interpreter {$a->email} has languages "{$a->actual}" on Zoom but "{$a->expected}" was expected.';
$string['verify_recording_mismatch'] = 'Automatic recording is "{$a->actual}" on Zoom but "{$a->expected}" was expected. The host\'s Zoom account may not allow this recording type.';
$string['verify_waitingroom_mismatch'] = 'Waiting room is {$a->actual} on Zoom but {$a->expected} was expected.';
$string['interpretation_enable'] = 'Spoken-language interpretation';
$string['interpretation_enable_label'] = 'Enable spoken-language interpretation';
$string['interpretation_enable_help'] = 'When enabled, interpreters can broadcast a translated audio channel during the meeting. Each interpreter must already exist as a licensed user on your Zoom account. For every interpreter pick the two languages they translate between (from / to).';
$string['interpretation_email'] = 'Interpreter email';
$string['interpretation_email_placeholder'] = 'name@example.com';
...
$string['interpretation_language'] = 'Language';
$string['interpretation_lang_from'] = 'From';
$string['interpretation_lang_to'] = 'To';
$string['interpretation_none'] = 'No interpreters added yet.';
$string['interpretation_add_interpreter'] = 'Add interpreter';
$string['sign_interpretation_enable'] = 'Sign-language interpretation';
$string['sign_interpretation_enable_label'] = 'Enable sign-language interpretation';
$string['sign_interpretation_enable_help'] = 'Sign-language interpretation is a separate Zoom feature from spoken-language interpretation. Each interpreter signs in one language during the meeting and must already exist as a user on your Zoom account.';
...
$string['err_interpretation_lang_required'] = 'Choose both the From and To languages for this interpreter.';
$string['err_interpretation_same_languages'] = 'From and To must be different languages.';
...
$string['err_interpretation_duplicate'] = 'This interpreter email is already in the list.';
