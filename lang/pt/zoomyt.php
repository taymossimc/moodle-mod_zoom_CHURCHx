...
$string['interpretation_enable'] = 'Ativar interpretação falada';
$string['interpretation_enable_desc'] = 'Os intérpretes devem ser usuários na sua conta Zoom. Cada linha: e-mail e códigos de idioma separados por vírgulas.';
$string['interpretation_spoken_lines'] = 'Intérpretes falados';
$string['interpretation_spoken_lines_help'] = 'Uma linha por intérprete: <code>email,idioma1,idioma2</code> com códigos Zoom (ex.: <code>US</code>, <code>ES</code>).';
$string['sign_interpretation_enable'] = 'Ativar interpretação em língua de sinais';
$string['sign_interpretation_enable_desc'] = 'Uma linha por intérprete: e-mail e língua de sinais (American, Chinese, French, etc.).';
$string['interpretation_sign_lines'] = 'Intérpretes em língua de sinais';
$string['interpretation_sign_lines_help'] = 'Uma por linha: <code>email,LinguaSinais</code> (ex.: <code>interprete@exemplo.edu,American</code>).';
