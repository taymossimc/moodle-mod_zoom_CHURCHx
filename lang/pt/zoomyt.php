...
$string['youtube_original_audio_language'] = 'Idioma da faixa de áudio original';
$string['youtube_original_audio_language_desc'] = 'Código de idioma BCP-47 aplicado à faixa de áudio original (sala) quando um vídeo é enviado (defaultAudioLanguage do YouTube). O YouTube só aceita códigos de idioma reais aqui - os códigos neutros «mul», «und» e «zxx» são recusados - por isso use um código concreto como «en», «en-US» ou «pt-BR». Para sessões multilingues em que também adiciona faixas separadas de inglês/português, dê à original um código distinto do dessas faixas (por ex. original «en», alternativas «en-US» e «pt-BR»). Deixe em branco para usar o idioma principal. O idioma dos metadados (título/descrição) não é afetado.';
...
$string['hosts'] = 'Anfitriões';
$string['transferhost'] = 'Transferir anfitrião para';
$string['transferhost_help'] = 'Transfere a propriedade desta reunião para outro docente. As sessões Zoom futuras são recriadas na conta Zoom do novo anfitrião e as sessões futuras substituídas são removidas do Zoom. As sessões que já decorreram, incluindo as suas gravações e relatórios, não são afetadas. Se o docente escolhido ainda não tiver uma conta Zoom, esta é criada automaticamente quando possível.';
$string['transferhost_keep'] = 'Manter o anfitrião atual';
$string['transferhost_success'] = 'Anfitrião da reunião transferido para {$a}. As sessões Zoom futuras foram recriadas com o novo anfitrião; as sessões passadas não foram alteradas.';
$string['transferhost_failed'] = 'Não foi possível transferir o anfitrião da reunião para {$a}.';
$string['transferhost_failed_noaccount'] = '{$a} ainda não tem uma conta Zoom ativa, por isso o anfitrião não foi alterado. Se acabou de receber um e-mail de convite do Zoom, peça-lhe que o aceite e tente novamente.';
$string['transferhost_nothingupcoming'] = 'O anfitrião não foi alterado porque esta reunião já terminou.';
$string['althosts_dropped'] = 'Estes anfitriões alternativos ainda não têm uma conta Zoom ativa e foram ignorados: {$a}. Quando possível, foi enviado um convite do Zoom e serão adicionados automaticamente assim que a conta estiver ativa.';
...
$string['sync_youtube_queued'] = 'A sincronização com o YouTube foi colocada na fila. As gravações são descarregadas e carregadas em segundo plano, o que pode demorar vários minutos em sessões longas. Atualize esta página para verificar o progresso.';
...
$string['retry_upload_queued'] = 'A nova tentativa de envio foi colocada na fila. A gravação será reprocessada em segundo plano. Atualize esta página para verificar o progresso.';
...
$string['duck_release_desc'] = 'A rapidez com que o áudio da sala regressa depois de o intérprete parar de falar. Predefinição: 350.';
$string['duck_level_sc'] = 'Ganho de deteção (sidechain) da atenuação';
$string['duck_level_sc_desc'] = 'Aumento de deteção aplicado à voz do intérprete ao decidir quanto atenuar o áudio original da sala. Valores mais altos tornam o original muito mais silencioso sob a tradução (atenuação mais pronunciada). 1 = sem aumento. Predefinição: 4.';
