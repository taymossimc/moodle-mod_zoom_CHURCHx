...
$string['meetinghost_help'] = 'A conta Zoom proprietária desta reunião. O anfitrião é dono das gravações na nuvem da reunião e inicia a sessão com a sua própria identidade. Pode escolher qualquer professor do curso que tenha uma conta Zoom; por predefinição é você. Não é possível alterar depois de a reunião ser criada.';
...
$string['video_status_deleted'] = 'Eliminado do YouTube';

// Ação de eliminação no YouTube.
$string['delete_from_youtube'] = 'Eliminar do YT';
$string['delete_from_youtube_confirm'] = 'Isto eliminará permanentemente o vídeo do YouTube. A sessão Zoom permanecerá listada abaixo. Continuar?';
$string['delete_youtube_success'] = 'O vídeo foi eliminado do YouTube.';
$string['delete_youtube_error'] = 'Não foi possível eliminar o vídeo do YouTube: {$a}';

// Ação para adicionar um vídeo do YouTube.
$string['add_youtube_video'] = 'Adicionar vídeo do YouTube';
$string['add_youtube_video_help'] = 'Cole o URL ou o ID de um vídeo do YouTube. O vídeo será adicionado às gravações da sessão e ficará visível para os alunos.';
$string['youtube_url'] = 'URL do YouTube';
$string['add_video_success'] = 'O vídeo do YouTube foi adicionado às gravações da sessão.';
$string['add_video_invalid_url'] = 'Isto não parece ser um URL ou ID de vídeo do YouTube válido.';
...
$string['sessions_uploaded_youtube'] = 'Sessões enviadas para o YouTube';
$string['feature_not_available'] = 'O ZoomYT não está incluído no seu plano de parceiro. Contacte a CHURCHx para atualizar a sua subscrição.';
...
$string['duck_ratio_desc'] = 'Rácio do compressor sidechain. Valores mais altos reduzem mais o áudio da sala. Predefinição: 8.';
$string['duck_release'] = 'Libertação da atenuação (ms)';
$string['duck_release_desc'] = 'A rapidez com que o áudio da sala regressa depois de o intérprete parar de falar. Predefinição: 300.';
$string['duck_threshold'] = 'Limiar de atenuação';
$string['duck_threshold_desc'] = 'Limiar do compressor sidechain (amplitude linear, 0-1). Valores mais baixos atenuam o áudio da sala mais facilmente quando o intérprete fala. Predefinição: 0.03.';
$string['enable_multilang_audio'] = 'Ativar faixas de áudio multilingues';
$string['enable_multilang_audio_desc'] = 'Quando ativado, a tarefa de sincronização com o YouTube cria uma mistura de áudio atenuada (áudio da sala por baixo da voz do intérprete) para cada idioma de interpretação e anexa-a ao vídeo carregado.';
$string['ffmpeg_path'] = 'Caminho do ffmpeg';
$string['ffmpeg_path_desc'] = 'Caminho completo para o binário do ffmpeg. Deixe vazio para detetar automaticamente no PATH do sistema.';
$string['ffprobe_path'] = 'Caminho do ffprobe';
$string['ffprobe_path_desc'] = 'Caminho completo para o binário do ffprobe. Deixe vazio para detetar automaticamente no PATH do sistema.';
$string['multilang_audio_settings'] = 'Áudio de interpretação multilingue';
$string['multilang_audio_settings_desc'] = 'Sintetiza faixas de áudio por idioma a partir das gravações de interpretação de idiomas do Zoom e anexa-as ao vídeo do YouTube como faixas de áudio alternativas. Requer o ffmpeg/ffprobe instalados no servidor, a definição da conta Zoom «Gravar intérprete de idioma» ativada antes das reuniões e um canal do YouTube elegível para áudio multilingue.';
$string['video'] = 'Vídeo';
$string['youtube_audiotrack_init_error'] = 'Falha ao inicializar o carregamento da faixa de áudio do YouTube: {$a}';
$string['youtube_audiotrack_upload_error'] = 'Falha ao carregar a faixa de áudio do YouTube: {$a}';
$string['yt_primary_language'] = 'Idioma principal do YouTube';
$string['yt_primary_language_coursedefault'] = 'Predefinição do curso ({$a})';
$string['yt_primary_language_help'] = 'A designação de idioma utilizada para os carregamentos no YouTube desta atividade (o idioma predefinido do vídeo e a faixa de áudio predefinida). Escolha «Predefinição do curso» para seguir o idioma do curso ou substitua-o aqui.';

// Post-creation settings verification.
$string['interpretation_spoken_label'] = 'Interpretação de idiomas';
$string['interpretation_sign_label'] = 'Interpretação em língua gestual';
$string['verify_problems_intro'] = 'Aviso: a reunião foi guardada, mas não foi possível confirmar algumas definições do Zoom:';
$string['verify_fetch_failed'] = 'Não foi possível verificar as definições da reunião do Zoom: {$a}';
