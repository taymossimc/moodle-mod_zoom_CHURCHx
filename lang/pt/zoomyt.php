...
$string['interpretation_enable_help'] = 'Quando ativada, os intérpretes podem transmitir um canal de áudio traduzido durante a reunião. Cada intérprete deve ser um usuário licenciado na sua conta Zoom. O Zoom emparelha cada intérprete com o inglês; escolha o segundo idioma para o qual ele traduz.';
...
$string['err_interpretation_lang_required'] = 'Escolha o idioma deste intérprete.';
