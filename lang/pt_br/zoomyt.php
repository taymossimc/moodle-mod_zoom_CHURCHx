...
$string['feature_not_available'] = 'O ZoomYT não está incluído no seu plano de parceiro. Entre em contato com a CHURCHx para atualizar sua assinatura.';
...
$string['notes'] = 'Notas';
$string['audiotrack_manualupload_note'] = 'Pronta para envio manual no YouTube Studio (aba Idiomas).';
$string['audiotrack_file_missing'] = 'O arquivo da faixa de áudio sintetizada não está mais disponível.';
...
$string['verify_recording_mismatch'] = 'A gravação automática está "{$a->actual}" no Zoom, mas era esperada "{$a->expected}". A conta Zoom do anfitrião pode não permitir esse tipo de gravação.';
